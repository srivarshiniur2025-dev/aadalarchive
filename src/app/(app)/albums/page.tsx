  ...
  return (
    <div className="mx-auto max-w-6xl">
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 className="font-display text-[clamp(1.6rem,3vw,2.2rem)] text-cream">Events / Albums</h2>
      ...
      {albums.length === 0 ? (
        <div className="app-panel mt-16 px-6 py-16 text-center">
          <p className="font-display text-2xl text-cream">Your first album is waiting.</p>
      ...
      {open ? (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div
            ...
            className="relative z-[1] max-h-[90vh] w-full max-w-md overflow-y-auto rounded-xl border border-cream/[0.1] bg-[#12131a] p-5 shadow-2xl"
          >
