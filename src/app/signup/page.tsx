    ...
    <div className="grid min-h-screen lg:grid-cols-[0.55fr_0.45fr]">
      <aside className="relative hidden min-h-screen lg:block">
        <Image
          ...
          sizes="55vw"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-maroon/25 via-temple/45 to-parchment" />
        ...
        <div className="absolute bottom-12 left-12 right-12">
          ...
          <p className="font-script mt-3 text-3xl text-ivory">Rooted · Eternal</p>
      ...
      <div className="relative flex flex-col justify-center bg-paper px-6 py-12 md:px-12">
        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <p className="mt-8 text-center text-sm text-ink-soft">
            ...
            <Link href="/login" className="text-temple hover:underline">
              Sign in
            </Link>
          </p>
        </div>
